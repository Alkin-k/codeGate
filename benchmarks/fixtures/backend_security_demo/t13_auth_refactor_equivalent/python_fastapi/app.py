"""FastAPI backend with auth refactored.

T13: Auth decorator/dependency renamed to get_authenticated_user.
"""
...
async def require_admin(user=Depends(get_authenticated_user)):
...
async def get_tenant(user=Depends(get_authenticated_user)):
