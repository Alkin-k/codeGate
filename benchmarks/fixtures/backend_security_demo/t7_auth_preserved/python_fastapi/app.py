"""FastAPI backend with auth, authorization, and tenant scope.

This is a realistic ~150 line FastAPI application that serves as
the baseline for CodeGate backend security demo tests (T7-T12).
"""
